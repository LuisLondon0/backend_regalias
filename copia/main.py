...
from routers import (
    ...
    counterpart_router,
    sgr_router,
    training_events_router,
    technical_service_router,
)
...
app.include_router(
    users_projects_router.router, prefix="/api/v1", tags=["Users Projects"]
)
app.include_router(
    specific_objective_router.router, prefix="/api/v1", tags=["Specific Objectives"]
)
...
app.include_router(
    annual_honorariums_router.router, prefix="/api/v1", tags=["Annual Honorariums"]
)
app.include_router(
    equipment_software_router.router, prefix="/api/v1", tags=["Equipment Softwares"]
)
...
app.include_router(
    training_events_router.router, prefix="/api/v1", tags=["Training events"]
)
app.include_router(
    technical_service_router.router, prefix="/api/v1", tags=["Technical Services"]
)
